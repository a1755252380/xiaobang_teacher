  ...
  <el-container >
    ...
    <el-row :gutter="10" style="width:100%">
      <el-col :xs="24"
              ...
              :md="24"
              :lg="5"
              :xl="5"> <div class="result_container">
      <el-card>
        <h1>能力评估</h1>
        <div id="myChart"></div>
        <ul class="result_ul">
          ...
          >
            ...
            ></el-progress>
              ...
              :md="24"
              :lg="14"
              :xl="14"><div class="middle_container">
      ...
      <el-card class="course_container">
        ...
        >
          ...
          <div class="teacher_name">
            <i class="el-icon-user"></i><span>授课学生：</span><span>{{item.student}}</span>
          </div>
          <div class="classroom_name">
            <i class="el-icon-house"></i><span>地点：</span><span>{{item.place}}</span>
              ...
              :md="24"
              :lg="5"
              :xl="5"> <div class="right_container">
...
export default {
  ...
  mounted: function () {
    this.$store.commit('ts_random_class');
    let level=["八","九","十"];
   ...
   for(let i=1;i<=sum;i++){
     let a=parseInt(1+Math.random()*5);
      if (a==num) {
        ...
        num=a
       teacherList.push( { id: i, teacherName: this.$store.state.student_name[parseInt(Math.random()*this.$store.state.student_name.length
       )], teacherImgSrc: require("../../assets/images/student/"+a+".jpg") })
      }
   }
    let data={
          ...
          teacherList:teacherList,  abilityList:[
            {
              "id": 1,
              "name": "音准",
              "score":  90+parseInt(Math.random()*10)
            },
            {
              "id": 2,
              "name": "指法",
          ...
          ,level:level[parseInt(Math.random()*3)],
          courseList:this.$store.state.t_random_class
      }
    //统一课程的安排同授课学生一致
    let zz=''
    for(let i=0;i<teacherList.length;i++){
      if (i<teacherList.length&&i!=0) {
        zz+="、"
      }
      zz+=teacherList[i].teacherName
    }
    for(let i=0;i<data.courseList.length;i++){
      data.courseList[i].student=zz
    }
